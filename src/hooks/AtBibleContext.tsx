...
import bibleDataAA from "../../biblia/aa/AT.json";
import bibleDataACF from "../../biblia/acf/AT.json";
import bibleDataNVI from "../../biblia/nvi/AT.json";
...
const AtBibleContext = createContext<BibleContextData>({} as BibleContextData);
...
function AtBookProvider({ children }: BibleProviderProps){
    ...
    return (
        <AtBibleContext.Provider value={{
            ...
            { children }
        </AtBibleContext.Provider>
    )
}

function useBook(): BibleContextData {
    return useContext(AtBibleContext);
}
